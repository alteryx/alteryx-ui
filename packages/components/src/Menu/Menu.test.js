...
describe('<Menu />', () => {
  ...
  describe('list node', () => {
    ...
    it('should render a MenuList inside the Popover', () => {
      ...
      expect(wrapper.find(Popover).find(MenuList).exists()).toBe(true);
    });
  });
  ...
  describe('cascading menu', () => {
    ...
    it('sub menu stays open when mouse is outside of menu', () => {
      ...
      expect(wrapper.find('#dark-mode').last().exists()).toBe(true);
    });
    ...
    it('changes focus with up and down arrow buttons', () => {
      ...
      expect(wrapper.find('#dark-mode').last().hasClass('Mui-focusVisible')).toBe(true);

      wrapper.find('#dark-mode').last().simulate('keyDown', {
        key: 'ArrowDown'
      });
      expect(wrapper.find('#dark-mode').last().hasClass('Mui-focusVisible')).toBe(false);
    ...
    it('changes focus with left and right arrow buttons', () => {
      ...
      expect(wrapper.find('#settings-item').last().hasClass('Mui-focusVisible')).toBe(true);
