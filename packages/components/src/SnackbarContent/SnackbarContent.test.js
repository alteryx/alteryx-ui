...
describe('SnackbarContent', () => {
  test('renders a SnackbarContent in `light` mode when open prop is true', () => {
    const { container } = muiThemeWrapper(<SnackbarContent message="Toasty" open />);
  ...
  test('renders a list of `action` items', () => {
    ...
    const { container } = muiThemeWrapper(<SnackbarContent action={actionItems} message="Toasty" open />);
  ...
  test('renders an `action` item', () => {
    ...
    const { container } = muiThemeWrapper(<SnackbarContent action={actionItem} message="Toasty" open />);
