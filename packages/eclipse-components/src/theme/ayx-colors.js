const styleguideColors = {
  ...
  'red-hover': '#dc5b6c',
  'red-pressed': '#ca283d',
  'border-light': 'rgba(0, 0, 0, 0.23)',
  'border-dark': 'rgba(243, 247, 255, 0.1)',
  white: '#ffffff',
  transparent: 'transparent'
};

styleguideColors['gradient-hot-sauce'] = `linear-gradient(154deg, #A04961, ${styleguideColors['brand-hot-sauce']})`;
styleguideColors['gradient-blue-razz'] = `linear-gradient(154deg, #214860, ${styleguideColors['brand-blue-razz']})`;
styleguideColors['gradient-deep-space'] = `linear-gradient(154deg, #1b406c, ${styleguideColors['brand-deep-space']})`;
styleguideColors['gradient-alteryx-blue'] = `linear-gradient(154deg, #3BB9FF, ${
  styleguideColors['brand-corporate-blue']
})`;
